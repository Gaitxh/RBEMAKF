function res = tracking_GSTMKF(sim)
...
for k = 1 : sim.length
    ...
    h=0.15;
    v=5;
    [x_k_1k_1,P_k_1k_1]=gstmkf(x_k_1k_1,P_k_1k_1,F_k,H_k,z_k,Q_k,R_k,N,e,f,g,h,v,v);
...
function [xkk,Pkk]=gstmkf(xkk,Pkk,F,H,z,Q,R,N,e0,f0,g0,h0,v1,v2)
